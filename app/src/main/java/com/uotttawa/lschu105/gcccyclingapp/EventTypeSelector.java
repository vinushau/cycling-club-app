...
public class EventTypeSelector extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_event_type_selector);

        final LinearLayout buttonContainer = findViewById(R.id.buttonContainer);

        retrieveEventTypesFromFirebase(eventTypes -> {
            for (int i = 0; i < eventTypes.size(); i++) {
                final TextView groupNameTextView = new TextView(EventTypeSelector.this);
                ...
                CardView cardView = new CardView(EventTypeSelector.this);
                ...
                TextView selectButton = new TextView(EventTypeSelector.this);
                ...
                LinearLayout separator = new LinearLayout(EventTypeSelector.this);
